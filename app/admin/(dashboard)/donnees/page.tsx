...
const suiviFields: FieldConfig[] = [
  ...
  { key: "consoPuffSemaine", label: "Puffs / semaine", type: "number", min: 0 },
  { key: "consoSnusSemaine", label: "Paquets snus / semaine", type: "number", min: 0 },
  { key: "consoCigaretteSemaine", label: "Paquets cig. / semaine", type: "number", min: 0 },
