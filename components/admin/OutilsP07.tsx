...
const ACTIONS: Action[] = [
  {
    ...
    description:
      "Remplace le carnet, les séances et les mesures T0/T1/T2 de TOUS les participants par le jeu de données réaliste (profils de personnalité), avec le cardio neutre et une taille d'effet cardio/musculation crédible (d ≈ 0,43). Action à confirmer : elle écrase les données existantes.",
